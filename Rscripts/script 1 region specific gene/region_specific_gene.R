...
# expression matrix Supplementary_Table_2.xlsx
...
library(rio)
library(dplyr)
norm.new <- read_excel("Supplementary_Table_2.xlsx")
...
# sample metadata
meta.new <- read.csv("Supplementary_Table_1.csv", stringsAsFactors = F)
...
export(region_specific_feature, "region_specific_gene_summary.xlsx")
...
save.image("region_specific_gene.RData")
