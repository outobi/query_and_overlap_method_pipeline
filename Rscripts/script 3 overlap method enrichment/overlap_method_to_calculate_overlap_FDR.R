...
export(summary, "summary_of_d_value_31_cell_types_in_IPF.xlsx")
...
export(summary2, "summary_of_d_value_30_cell_types_in_control.xlsx")
...
ggsave("overlap_enrichment_heatmap_summary.pdf", plot = p1, width = 8.5, height = 11)  
...
ggsave("overlap_positive_enrichment_bubble_plot_summary.pdf", plot = p2, width = 8.5, height = 11)  
ggsave("overlap_negative_depletion_bubble_plot_summary.pdf", plot = p3, width = 8.5, height = 11)  

# save data
save.image("overlap_method_to_calculate_overlap_FDR.RData")
